...
/**
 * Robust image resolver following specific priority:
 * 1. product.image
 * 2. product.image_url
 * 3. product.variants?.[0]?.image_url
 * 4. product.variants?.[0]?.gallery_images?.[0]
 * 5. fallback placeholder
 */
export const getProductImage = (product) => {
  if (!product) return "/images/toy-placeholder.svg";
