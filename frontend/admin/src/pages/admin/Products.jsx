            ...
            <tbody className="divide-y divide-gray-50">
              {filtered.map((p) => {
                const productImage =
                  ...
                  p.image_urls?.[0] ||
                  p.gallery?.[0] ||
                  "/images/toy-placeholder.svg";
                return (
                <tr key={p.id} className="table-row">
                  <td className="table-td">
                    <div className="flex items-center gap-3">
                      <img src={formatImageUrl(productImage)} alt={p.name} className="w-11 h-11 rounded-xl object-cover bg-orange-50 flex-none" onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/images/toy-placeholder.svg'; }} />
                      <div>
